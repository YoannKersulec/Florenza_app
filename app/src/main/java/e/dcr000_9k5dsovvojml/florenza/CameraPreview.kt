...
class CameraPreview(context: Context, private var mCamera: Camera?) : SurfaceView(context), SurfaceHolder.Callback {
    ...
    override fun surfaceCreated(holder: SurfaceHolder) {
        try {
            ...
            Toast.makeText(this.context, "Error setting camera preview", Toast.LENGTH_LONG).show()
    ...
    fun refreshCamera(camera: Camera?) {
        ...
        try {
            ...
            Toast.makeText(this.context, "Error starting camera preview", Toast.LENGTH_LONG).show()
